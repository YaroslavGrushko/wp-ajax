          ...
          <div class="footer__container">
            ...
            <div class="footer__block">
              <div class="footer__title">
                <h2><?php the_field("social_media_label"); ?></h2>
              </div>
              <div class="socials">
                ...
                <a href="<?php the_field("instagram_ink"); ?>">
            ...
            <div class="footer__block">
              ...
              <address><?php the_field("contact_brand"); ?><br> <?php the_field("addresss"); ?></address>
              <p class="developed-by"><?php the_field("developed_by_title"); ?> <a href="<?php the_field("developed_by_link"); ?>" target="_blank"><?php the_field("developed_by_link_text"); ?></a></p>
            </div>
          </div>
        </div>
      </footer>
