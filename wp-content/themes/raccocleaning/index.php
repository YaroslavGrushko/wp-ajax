    ...
    <div class="app">
          ...
          <div class="header__container">
            <div class="header__logo-container">
              <a href="" class="header__logo">
                <img src="/static/app/img/logo-white.svg" class="header__logo-white" alt="RaccoCleaning">
                <img src="/static/app/img/logo-black.svg" class="header__logo-black" alt="RaccoCleaning">
              </a>
            </div>
      ...
      <div class="menu">
        <div class="menu__close">
          <img src="/static/app/img/ico-close.svg" alt="close">
        </div>
        <div class="menu__inner">
          <a href="" class="menu__logo header__logo">
            <img src="/static/app/img/logo-black.svg" alt="RaccoCleaning">
          </a>
          <div class="menu__btn">
      ...
      <main class="content">
        <section class="promo">
          <div class="promo__bg">
            <picture>
              <source media="(max-width: 768px)" srcset="/static/app/img/promo_mobile.png" />
              <source media="(min-width: 769px)" srcset="/static/app/img/promo.png" />
              <img src="/static/app/img/promo.png" alt="" role="presentation" />
            </picture>
          </div>
          <div class="container">
          ...
          <div class="container">
            ...
            <div class="services__container">
              <article class="services__item">
                <div class="services__item-head">
                  <div class="services__item-ico">
                    <img src="/static/app/img/ico-plumbing.svg" alt="" role="presentation">
                  </div>
              ...
              <article class="services__item">
                <div class="services__item-head">
                  <div class="services__item-ico">
                    <img src="/static/app/img/ico-computer.svg" alt="" role="presentation">
                  </div>
                  <div class="services__item-title">
                    <h3>Deep</h3>
                  </div>
              ...
              <article class="services__item">
                <div class="services__item-head">
                  <div class="services__item-ico">
                    <img src="/static/app/img/ico-vacuum.svg" alt="" role="presentation">
                  </div>
                  <div class="services__item-title">
                    <h3>Move in/out</h3>
                  </div>
          ...
          <div class="container">
            <div class="reasons__container">
              ...
              <ul class="reasons__list">
                <li>
                  <img src="/static/app/img/ico-bubbles.svg" alt="" role="presentation"> Free cleaning supplies </li>
                <li>
                  <img src="/static/app/img/ico-shopping-cart.svg" alt="" role="presentation"> Superior order customization </li>
                <li>
                  <img src="/static/app/img/ico-badge.svg" alt="" role="presentation"> Exceptional quality & consistency </li>
                <li>
                  <img src="/static/app/img/ico-cleaning-spray.svg" alt="" role="presentation"> Free rooms freshener & deodorizing </li>
                <li>
                  <img src="/static/app/img/ico-5-stars.svg" alt="" role="presentation"> Pre-screened professional maids </li>
                <li>
                  <img src="/static/app/img/ico-money.svg" alt="" role="presentation"> No hidden fees </li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div class="steps__container">
              <article class="steps__item">
                <div class="steps__item-ico">
                  <img src="/static/app/img/ico-raccoon-book.svg" alt="" role="presentation">
                </div>
                ...
                <div class="steps__item-steps-side">
                  <img src="/static/app/img/steps-side.svg" alt="" role="presentation">
                </div>
                <div class="steps__item-steps-bottom">
                  <img src="/static/app/img/steps-bottom.svg" alt="" role="presentation">
                </div>
                <div class="steps__item-steps-mobile">
                  <img src="/static/app/img/steps-mobile.svg" alt="" role="presentation">
                </div>
              </article>
              <article class="steps__item">
                <div class="steps__item-ico">
                  <img src="/static/app/img/ico-raccoon-clean.svg" alt="" role="presentation">
                </div>
                <div class="steps__item-text">
                  <div class="steps__item-title">
                    <h3>Clean</h3>
              ...
              <article class="steps__item">
                <div class="steps__item-ico">
                  <img src="/static/app/img/ico-raccoon-relax.svg" alt="" role="presentation">
                </div>
                <div class="steps__item-text">
                  <div class="steps__item-title">
                    <h3>Relax</h3>
                      ...
                      <div class="reviews__item-info">
                        <div class="reviews__item-author">
                          <div class="reviews__item-author__avatar">
                            <img src="/static/app/img/avatar.png" alt="">
                          </div>
        ...
        <section class="faq" id="faq">
          <div class="container">
            ...
            <div class="faq__container">
              ...
              <div class="faq__img">
                <img src="/static/app/img/fag_img.png">
              </div>
            </div>
          </div>
        </section>
