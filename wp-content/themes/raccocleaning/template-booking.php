...
<div class="app">
    ...
    <div class="container">
        ...
        <div class="header__logo-container">
            ...
            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/logo-white.svg'); ?>" class="header__logo-white" alt="RaccoCleaning">
            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/logo-black.svg'); ?>" class="header__logo-black" alt="RaccoCleaning">
            </a>
        </div>
    ...
    <div class="menu__close">
        <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/ico-close.svg'); ?>" alt="close">
    </div>
    ...
    <section class="promo">
        <div class="promo__bg">
        <picture>
            <source media="(max-width: 768px)" srcset="<?php echo esc_url( get_template_directory_uri() . '/assets/images/promo_mobile.png'); ?>" />
            <source media="(min-width: 769px)" srcset="<?php echo esc_url( get_template_directory_uri() . '/assets/images/promo.png'); ?>" />
            <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/promo.png'); ?>" alt="" role="presentation" />
        </picture>
        </div>
        <div class="container">
    ...
    <section class="steps">
        ...
        <div class="steps__container">
            ...
            <div class="steps__item-ico">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/ico-raccoon-book.svg'); ?>" alt="" role="presentation">
            </div>
            ...
            <div class="steps__item-steps-side">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/steps-side.svg'); ?>" alt="" role="presentation">
            </div>
            <div class="steps__item-steps-bottom">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/steps-bottom.svg'); ?>" alt="" role="presentation">
            </div>
            <div class="steps__item-steps-mobile">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/steps-mobile.svg'); ?>" alt="" role="presentation">
            </div>
            </article>
            <article class="steps__item">
            <div class="steps__item-ico">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/ico-raccoon-clean.svg'); ?>" alt="" role="presentation">
            </div>
            <div class="steps__item-text">
                <div class="steps__item-title">
            ...
            <article class="steps__item">
            <div class="steps__item-ico">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/ico-raccoon-relax.svg'); ?>" alt="" role="presentation">
            </div>
            <div class="steps__item-text">
                <div class="steps__item-title">
